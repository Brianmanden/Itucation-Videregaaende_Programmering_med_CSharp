...
namespace Eksamensprojekt.Server.Models;

public partial class EksamensprojektContext : DbContext
{
    public EksamensprojektContext()
    {
    }

    public EksamensprojektContext(DbContextOptions<EksamensprojektContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:Eksamensprojekt");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECAF72E550A");
