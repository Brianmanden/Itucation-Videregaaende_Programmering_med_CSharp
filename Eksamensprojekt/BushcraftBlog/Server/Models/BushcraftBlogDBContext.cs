    ...
    public class BushcraftBlogDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Topic>().HasData(
                new Topic { Name = topics[0].Name, Description = topics[0].Description },
                new Topic { Name = topics[1].Name, Description = topics[1].Description },
                new Topic { Name = topics[2].Name, Description = topics[2].Description }
            );

            modelBuilder.Entity<Tag>().HasData(
                new Tag { Name = tags[0].Name, Description = tags[0].Description },
                new Tag { Name = tags[1].Name, Description = tags[1].Description },
                new Tag { Name = tags[2].Name, Description = tags[2].Description },
                new Tag { Name = tags[3].Name, Description = tags[3].Description },
                new Tag { Name = tags[4].Name, Description = tags[4].Description },
                new Tag { Name = tags[5].Name, Description = tags[5].Description },
                new Tag { Name = tags[6].Name, Description = tags[6].Description }
            );
